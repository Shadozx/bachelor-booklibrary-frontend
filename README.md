...
| Роль              | Можливості                                                                 |
|-------------------|----------------------------------------------------------------------------|
| **Користувач**     | Реєстрація, перегляд, пошук і сортування книг, читання розділів, додавання / редагування / видалення оцінок (1–5), коментарів, закладок         |
| **Адміністратор**  | Усі можливості користувача + керування бібліотекою (додавання, редагування, видалення книг)                        |
| **Суперадміністратор** | Усі можливості адміністратора + керування користувачами (змінна ролей, блокування)     |

Кожен рівень має доступ до всіх можливостей попередніх ролей.

## Взаємодія з бекендом

Frontend взаємодіє з бекенд-проєктом [`bachelor-booklibrary-backend`](https://github.com/Shadozx/bachelor-booklibrary-backend) через REST API. JWT-токен використовується для аутентифікації та авторизації і передається в заголовках HTTP-запитів.
